...
public class TreeCheckingEvent extends EventObject {
   ...
   * 
   */
  private static final long serialVersionUID = -54846602404381813L;
     ...
     *            source of event
     * @param path
     *            the path that has changed in the checking
     * @param checked
     *            whether or not the path is checked, false means that path was
