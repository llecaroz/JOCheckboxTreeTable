 ...
 * Adding/removing paths is delegated to a CheckingMode instance. This implementation is based on
 * TreePath only and does not take advantage of TreeNode convenience methods (this is left to
...
public class DefaultTreeCheckingModel implements TreeCheckingModel
{
  ...
  /**
   * Adds x to the list of listeners that are notified each time the set of checking TreePaths
   * changes.
   * 
   * @param x
  ...
  /**
   * Return the paths that are children of path, using methods of TreeModel. Nodes don't have to be
   * of type TreeNode.
   * 
   * @param path
   *          the parent path
  ...
  /**
   * @return true if exists a child of node with a value different from itself.
   * @param path
  ...
  /**
   * @return true if exists a node with checked status value in the subtree of path.
   * @param path
  ...
  /**
   * Removes x from the list of listeners that are notified each time the set of checking TreePaths
   * changes.
   * 
   * @param x
  ...
  /**
   * Sets the specified checking mode. The consistence of the existing checking is not enforced nor
   * controlled.
   */
  ...
  /**
   * Return a string that describes the tree model including the values of checking, enabling,
   * greying.
   */
  @Override
  ...
  /**
   * Convenience method for getting a string that describes the tree starting at the specified path.
   * 
   * @param path
  ...
  private String toString(TreePath path)
  {
    ...
    String description = "Path checked: " + checkString + " greyed: " + greyString + " enabled: " + enableString
          + " Name: "
          + path.toString() + "\n";
  ...
  /**
   * Updates the grayness value of the parents of path. Note: the greyness and checking of the other
   * nodes (not ancestors) MUST BE consistent.
   * 
   * @param path
  ...
  /**
   * Updates consistency of the checking, by invoking updateSubTreeCheckingConsistency on the root
   * node.
   */
  ...
  /**
   * Updates the greyness value value for the given path if there are children with different
   * values. Note: the greyness and cheking of children MUST BE consistent.
   * 
   * @param ancestor
